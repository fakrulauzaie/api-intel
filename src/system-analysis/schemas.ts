...
export const jobQueueContractSchema = z
  .object({
...
export const microserviceContractSchema = z
  .object({
...
export const systemInteractionEndpointSchema = z
  .object({
...
export const systemAnalysisDocumentSchema = z
  .object({
    ...
    interactionEndpoints: z.array(systemInteractionEndpointSchema),
