...
The built CLI scanned `orders-api-example` into an isolated workspace output.
...
- `orders-index-api-sync`;
- `orders-verify-api-sync`;
- `orders-verify-background`;
- `workflow-verify-background`; and
- `workflow-verify-api-sync`.
