...
describe('Phase 45 System Stitching Gate S0', () => {
  it('freezes both technologies, every topology, every state, and the synthetic RMQ pair', async () => {
    ...
    expect(manifest.syntheticBasis).toEqual({
      ...
      consumerSourceFiles: ['src/main.ts', 'src/modules/orders/orders.controller.ts'],
    });
  });
