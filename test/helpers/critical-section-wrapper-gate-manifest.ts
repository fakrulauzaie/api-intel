...
export const criticalSectionWrapperGateManifestSchema = z
  .object({
    ...
    syntheticBasis: z
      .object({
        repository: z.literal('orders-api-example'),
        callerSourceFile: z.literal('src/modules/workflow/workflow.service.ts'),
        wrapperSourceFile: z.literal('src/modules/redis/redis-lock.service.ts'),
        entryMethod: z.literal('WorkflowService.resolveTicket'),
        wrapperChain: z.tuple([
          z.literal('RedisLockService.executeWithWorkflowLock'),
